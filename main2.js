  ...
  auth
    ...
    .then((userCredentials) => {
      ...
      swal(
        ...
        " Bienvenido: " +
          loginEmail +
          ", en unos segundos te redirigiremos a nuestra pagina de compras",
        "success"
      );
      setTimeout(function () {
    ...
    .catch((err) => {
      swal(
        "Ohh no!",
        "Algo ha sucecido por favor intentalo mas tarde!",
        "error"
      );
      console.log(err);
    });
...
var cambio_pw = function () {
  ...
  auth
    ...
    .then(() => {
      swal(
        "Se ha enviado un correo a su cuenta, por favor siga todas las intruciones"
      );
    })
    .catch((err) => {
